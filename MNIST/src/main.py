...
def main() -> None:
    ...
    print(f"Train-set accuracy: {accuracy_score(train_labels.data, predictions_train):.6f}")
    print(f"Test-set accuracy: {accuracy_score(test_labels.data, predictions_test):.6f}")
